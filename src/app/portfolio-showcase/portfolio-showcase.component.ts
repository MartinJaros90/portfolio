  ...
  contentForCard: Card[] = [
    {
      ...
      test: 'https://martin-jaros.developerakademie.net/pokedex/index.html',
    },
    {
      number: 2,
      id: 1,
      ...
      test: 'https://martin-jaros.developerakademie.net/sharkie/index.html',
    },
    {
      number: 3,
      id: 3,
      ...
      test: 'https://martin-jaros.developerakademie.net/join/login.html',
    },
  ];
